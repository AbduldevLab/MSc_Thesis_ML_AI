...
\addcontentsline{toc}{chapter}{Appendix A: Python code for exporting PMF metadata}
...
\addcontentsline{toc}{chapter}{Appendix B: Scenario Cleaning Pipeline Tables}
\chaptermark{Appendix}
\markboth{Appendix}{Appendix}
...
\addcontentsline{toc}{chapter}{Appendix C: First Stage Variable Mapping Code}
\chaptermark{Appendix}
\markboth{Appendix}{Appendix}
...
\addcontentsline{toc}{chapter}{Appendix D: Second Stage deterministic six step cleaning engine}
\chaptermark{Appendix}
\markboth{Appendix}{Appendix}
