...
The dimensions of the triaged datasets, which serve as the input for the scripted cleaning engine, are reported below.
\begin{table}[htbp]
\centering
...
\begin{enumerate}
    ...
    \item \textbf{Censored Categorical:} Applies known ordinal transformations (e.g., health scales, Likert ranges) conducted manually , low count == (hard coded mappings).
